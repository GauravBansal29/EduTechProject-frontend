...
const UserIndex=()=>{
    ...
    return (
        <UserRoute>
            ...
            {
                !courses && <div>No courses to display</div>
            }
            {/* <pre>{JSON.stringify(courses, null,4)}</pre> */}
               ...
               { courses && courses.map((course)=>{
                    ...
                    <div className="progress">
                     <div className="progress-bar" role="progressbar" style={{backgroundColor:"rgba(75,0,130,0.4)" ,width: "25%"}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
